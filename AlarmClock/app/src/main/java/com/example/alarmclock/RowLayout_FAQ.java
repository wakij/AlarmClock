...
public class RowLayout_FAQ extends Fragment {
    ...
    public RowLayout_FAQ(String _question, String _answer)
    {
        answer = _answer;
        question = _question;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.row_layout_faq, container, false);
    }
